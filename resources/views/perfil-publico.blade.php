            ...
            <section>
                ...
                <form method="POST" action="/perfil-publico" >
                    ...
                    <div class="form-row">
                        ...
                        <input type="text" class="form-control" name="name" placeholder="Preencha seu nome" value="{{old('name')}}">
                        ...
                        <div class="form-group col-md-10">
                            <label>Email</label>
                            <input type="text" class="form-control" name="email"  placeholder="name@example.com" value="{{old('email')}}">
